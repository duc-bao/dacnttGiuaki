...
<body>
    <div class="container">
        <h2 class="text-center mb-5">Thêm Đơn Hàng</h2>
        <form name="f1" id="f1" method="post" action="xulithem.php" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        <label for="receive_date" class="form-label">Ngày nhận hàng:</label>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="d-grid gap-2">
                        <input type="submit" class="btn btn-primary" id="b1" name="b1" value="Thêm Đơn Hàng">
                    </div>
                </div>
            </div>
        </form>
